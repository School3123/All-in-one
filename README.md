...
### 例: Torrentファイル
※ PCにある `.torrent` ファイルを使いたい場合、先にWeb画面(後述)からアップロードしておくと、以下のように指定できます。
```bash
...
### ブラウザでのアクセス
起動後、右下に表示されるポップアップ**「Open in Browser」**をクリックするか、「PORTS」タブから **ポート 5000** の地球儀アイコンをクリックしてください。
